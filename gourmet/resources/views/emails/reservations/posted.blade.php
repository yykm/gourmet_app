...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #222222;">
    ...
    <![endif]-->
        ...
        <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
            ...
            the
            email subject line or even summarize the email's contents. Extended text preheaders (~490 characters) seems
            like a
            better UX for anyone using a screenreader or voice-command apps like Siri to dictate the contents of an
            email. If
            this text is not included, email clients will automatically populate it using the text (including image alt
            text)
        ...
        -->
        <div style="max-width: 600px; margin: 0 auto; margin-top: 30px !important" class="email-container">
            <!--[if mso]>
          ...
          <td style="padding: 20px 0; text-align: center">
                            ...
                            <tr>
                                <td
                                    ...
                                    <h1
                                        ...
                                        {{ $reservation->shop_id }}のご予約の内容のご確認</h1>
                                    <p style="margin: 0;">{{ $reservation->name }}様、以下の内容でご予約を承りました。</p>
                                </td>
                            </tr>
                            <!-- <tr>
                <td style="padding: 0 20px;"> -->
                    ...
                    Praesent in felis ut velit pretium lobortis rhoncus ut&nbsp;erat.</h2> -->
                                    <ul style="padding: 0; margin: 0 0 10px 0; list-style-type: disc;">
                                        <li style="margin:0 0 10px 10px;" class="list-item-first">店舗<p 77
                                                style="margin-top: 3px;">
                                                {{ $reservation->shop_id }}</p>
                                        </li>


                                        <li style="margin:0 0 10px 10px;">ご予約者名<p style="margin-top: 3px;">
                                                {{ $reservation->name }}&thinsp;様</p>
                                        </li>

                                        <li style="margin:0 0 10px 10px;">かな
                                            <p style="margin-top: 3px;">{{ $reservation->kana }}</p>
                                        </li>

                                        <li style="margin:0 0 10px 10px;">日付 <p style="margin-top: 3px;">
                                                {{ $reservation->date }}</p>
                                        </li>
                                        <li style="margin:0 0 10px 10px;">時間 <p style="margin-top: 3px;">
                                                {{ $reservation->time }}</p>
                                        </li>
                                        <li style="margin:0 0 10px 10px;">人数 <p style="margin-top: 3px;">
                                                {{ $reservation->number }}&thinsp;名</p>
                                        </li>
                                        <li style="margin:0 0 10px 10px;">ご利用目的 <p style="margin-top: 3px;">
                                                {{ $reservation->purpose }}</p>
                                        </li>
                                        <li style="margin: 0 0 10px 10px;" class="list-item-last">ご要望・ご意見 <p
                                                style="margin-top: 3px;">
                    ...
                    <td style="background-color: #ffffff;">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td
                                    style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <p style="margin: 0;">もしこのメールにお心当たりがないようでしたら、お手数ですが削除をお願いいたします。</p>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td
                        style="padding: 20px; font-family: sans-serif; font-size: 20px; line-height: 15px; text-align: center; color: #ffffff;">
                        <!-- <webversion style="color: #ffffff; text-decoration: underline; font-weight: bold;">View as a Web Page
            </webversion> -->
                        <br><br>
                        Gourmet.
                        <!--<br><span class="unstyle-auto-detected-links">123 Fake Street, SpringField, OR, 97477
