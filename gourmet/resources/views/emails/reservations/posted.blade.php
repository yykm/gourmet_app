              ...
              <tr>
                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                  ...
                  <ul style="padding: 0; margin: 0 0 10px 0; list-style-type: disc;">
                    <li style="margin:0 0 10px 10px;" class="list-item-first">店舗<p style="margin-top: 3px;">
                        {{ $reservation->shop_id }}</p>
                    </li>


                    <li style="margin:0 0 10px 10px;">ご予約者名<p style="margin-top: 3px;">{{ $reservation->name }}&thinsp;様</p>
                    </li>
                    ...
                    <li style="margin:0 0 10px 10px;">日付 <p style="margin-top: 3px;">{{ $reservation->date }}</p>
                    </li>
                    <li style="margin:0 0 10px 10px;">時間 <p style="margin-top: 3px;">{{ $reservation->time }}</p>
                    </li>
                    <li style="margin:0 0 10px 10px;">人数 <p style="margin-top: 3px;">{{ $reservation->number }}&thinsp;名</p>
                    </li>
                    <li style="margin:0 0 10px 10px;">ご利用目的 <p style="margin-top: 3px;">
                        {{ $reservation->purpose }}</p>
                    </li>
                    <li style="margin: 0 0 10px 10px;" class="list-item-last">ご要望・ご意見 <p style="margin-top: 3px;">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
        ...
        <tr>
          <td
            ...
            <br><br>
            Gourmet.<!--<br><span class="unstyle-auto-detected-links">123 Fake Street, SpringField, OR, 97477
